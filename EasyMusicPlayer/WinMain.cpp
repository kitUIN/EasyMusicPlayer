    ...
    _In_ int nShowCmd)
{
    ...
    winrt::com_ptr<winrt::EasyMusicPlayer::implementation::App> app =
        winrt::make_self<winrt::EasyMusicPlayer::implementation::App>();

    winrt::EasyMusicPlayer::MainPage XamlWindowContent =
        winrt::make<winrt::EasyMusicPlayer::implementation::MainPage>();
